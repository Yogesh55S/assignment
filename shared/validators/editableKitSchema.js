import { z } from "zod";
import { kitSourceSchema, roleSchema, scheduleSchema, coverageSchema, questionCategorySchema, } from "./kitSchema.js";
// Metadata schemas
...
export const editableInterviewPrepKitSchema = editableInterviewPrepKitBaseSchema.superRefine((data, ctx) => {
...
export function validateEditableInterviewPrepKit(input) {
    return editableInterviewPrepKitSchema.parse(input);
}
 ...
 */
export function stripInternalKitMetadata(kit) {
