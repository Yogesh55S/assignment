      ...
      <main className="flex-1 max-w-3xl 2xl:max-w-5xl w-full mx-auto px-3 sm:px-6 py-6 sm:py-8">
        ...
        {isSubmitting ? (
          ...
          <form
            ...
            className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 sm:p-6 shadow-sm space-y-5 sm:space-y-6"
          >
            ...
            <div>
              ...
              <input
                ...
                className="w-full text-xs sm:text-sm rounded-lg border border-slate-300 dark:border-slate-700 bg-transparent px-3 py-2 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-shadow"
                required
              />
              <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">
            ...
            <div>
              ...
              <input
                ...
                className="w-full sm:w-36 text-xs sm:text-sm font-semibold rounded-lg border border-slate-300 dark:border-slate-700 bg-transparent px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-shadow"
                required
              />
              <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">
            ...
            {/* Action buttons */}
            <div className="flex flex-col-reverse min-[425px]:flex-row items-stretch min-[425px]:items-center justify-end gap-2.5 sm:gap-3 pt-4 border-t border-slate-100 dark:border-slate-800">
              <Link
                href="/dashboard"
                className="px-4 py-2 text-center text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg border border-slate-300 dark:border-slate-700 transition-colors"
              >
                Cancel
              </Link>
              <button
                type="submit"
                className="px-5 py-2 text-xs sm:text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-sm transition-colors text-center"
              >
