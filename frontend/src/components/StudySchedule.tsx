...
import { RegenerateScheduleModal } from "./RegenerateScheduleModal";
    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 space-y-6 shadow-sm">
      ...
      {(hasDanglingReferences || hasUnsavedChanges) && (
        <div className="rounded-lg border border-amber-300 bg-amber-50 dark:border-amber-900 dark:bg-amber-950/30 p-3 text-xs text-amber-900 dark:text-amber-200 flex items-start gap-2.5">
          ...
          <div>
            <span className="font-semibold">Questions changed. Save changes before regenerating your schedule.</span>
      ...
      {/* Mandatory explanation note */}
      <p className="text-xs text-slate-500 dark:text-slate-400 italic pt-2 border-t border-slate-100 dark:border-slate-800">
        Your schedule is calculated by code using requirement priority and question difficulty. It is not generated by the AI model.
      </p>
